...
const RADAR_APP_VERSION = 'v8.1';
const RADAR_APP_LABEL = `Radar de Vida ${RADAR_APP_VERSION} - Training Intelligence`;
...
function buildPersonalRadarPrompt({ entries, periodLabel, profileName }) {
  return [
    ...
    '',
    'TAXONOMIA ESTRATEGICA DE EVENTOS RECORRENTES',
    '- Sempre tente mapear cada entrada para um ou mais eventTypes: gasto_consumo, investimento_aporte, rendimento_passivo, refeicao_nutricao, sono_recuperacao, peso_saude, atividade_fisica, missao_tarefa, vida_social, evento_memoria.',
    '- Uma mesma frase pode ter varios eventTypes. Ex.: jantar com a mae de R$ 89 = refeicao_nutricao + gasto_consumo + vida_social.',
    '- O eventType nao substitui domain nem box; ele cria uma camada estrategica recorrente para graficos e comparacoes mes contra mes.',
    '- Para investimento_aporte, preserve ticker, quantidade, valor, corretora, data e tese quando existirem.',
    '- Para rendimento_passivo, preserve origem, ticker/imovel, valor, competencia e data de pagamento quando existirem.',
    '- Para refeicao_nutricao, preserve alimentos, horario, calorias, proteina, carboidrato, gordura, fibra, saciedade e contexto social.',
    '- Para sono_recuperacao e peso_saude, preserve hora de dormir, hora de acordar, duracao, peso, energia, humor e sintomas.',
    '- Para missao_tarefa, preserve status, proxima acao, prazo, bloqueio e criterio de conclusao.',
    '- Para vida_social, indique se houve ganho relacional, cuidado, pertencimento, conflito, reparo ou celebracao.',
    '',
    ...
    'Cada item de "events" deve ter: sourceIndex, domain, box, eventType, title, dateHint, status, facts, estimates, metrics, missingFields, confidence.',
